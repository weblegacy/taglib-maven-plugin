 ...
 */
public class TagreferenceMojoTest
    extends TaglibPluginTestBase
{
     ...
     */
    public final void testGoalTagreference()
        throws Exception
    {
        ...
        this.maven.execute( project, Arrays
            .asList( new String[] { "net.sourceforge.maven-taglib:maven-taglib-plugin:tagreference" } ), eventMonitor,
                            new ConsoleDownloadMonitor(), new Properties(), basedir );
